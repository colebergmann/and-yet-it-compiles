...
public class TableEntryTest {
    ...
    public void testValidConstructor() throws Exception {
        ...
        assertEquals("Exported CSV must match input", te.exportAsCSV(), testCSV);
    ...
    public void testWeather() {
        ...
        assertEquals("Weather export does not match expected", te.exportAsCSV(), expectedCSVDateParams +
